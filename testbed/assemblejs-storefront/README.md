...
To add translations, create JSON files in a locales directory:
```json
// locales/en-US.json
{
  "greeting": "Hello, {name}!",
...
- **Component not rendering**: Check browser console for errors and verify that the component is registered correctly in server.ts
