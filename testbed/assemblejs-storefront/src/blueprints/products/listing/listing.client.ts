...
/**
 * Products Listing Client
 * 
 * This class handles client-side behavior for the Listing component.
 ...
 */
export class ListingClient extends Blueprint {
  ...
  protected override async onMount(): Promise<void> {
    try {
      ...
      preact.bootstrap(Listing, this.context);
      
      // Notify completion
      events.emit('products.listing.ready', { 
  ...
  private handleError(error: unknown): void {
    ...
    events.emit('component.error', {
      componentName: 'Products.Listing',
...
BlueprintClient.registerComponentCodeBehind(ListingClient);