 ...
 * 
 * This is the main entry point for the Notifications cookbook example.
 * It creates a server with components that demonstrate notification system techniques.
 * 
