 ...
 * 
 * This is the main entry point for the Drag and Drop cookbook example.
 * It creates a server with components that demonstrate drag and drop interface techniques.
 * 
