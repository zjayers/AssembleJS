 ...
 * 
 * This is the main entry point for the Data Visualization cookbook example.
 * It creates a server with components that demonstrate chart and graph techniques.
 * 
