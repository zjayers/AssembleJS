 ...
 * 
 * This is the main entry point for the Performance cookbook example.
 * It creates a server with components that demonstrate performance optimization techniques.
 * 
