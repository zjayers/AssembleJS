...
export function setupLogActions() {
  ...
  logViewers.forEach(logViewer => {
    ...
    fullscreenButton.innerHTML = '<svg class="log-action-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"></path></svg>';
    ...
    copyButton.innerHTML = '<svg class="log-action-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>';
    ...
    fullscreenButton.addEventListener('click', () => {
      ...
      const syncLogs = () => {
        ...
        const existingContent = fullscreenLogViewer.querySelector('.log-content-container');
        const actionsElement = fullscreenLogViewer.querySelector('.log-actions');
      ...
      const exitButton = fullscreenLogViewer.querySelector('.fullscreen-button');
      exitButton.title = 'Exit fullscreen';
      exitButton.setAttribute('data-message', 'Exit fullscreen');
      exitButton.innerHTML = '<svg class="log-action-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 3v3a2 2 0 0 1-2 2H3m18 0h-3a2 2 0 0 1-2-2V3m0 18v-3a2 2 0 0 1 2-2h3M3 16h3a2 2 0 0 1 2 2v3"></path></svg>';
      ...
      const fullscreenCopyButton = fullscreenLogViewer.querySelector('.copy-button');
        ...
        navigator.clipboard.writeText(content)
          .then(() => {
            ...
            setTimeout(() => {
              ...
              setTimeout(() => {
                fullscreenCopyButton.setAttribute('data-message', 'Copy log content');
              }, 300);
            }, 2000);
          });
      });
