            ...
            <div class="collections-list">
                ${collections.map(collection => `
                    <div class="collection-item">
                        ...
                        <div class="collection-stats">${collection.count || 0} documents</div>
                        <div class="collection-actions">
                            <button class="secondary-button view-collection-btn" data-collection="${collection.name}">View</button>
                            <button class="secondary-button delete-collection-btn" data-collection="${collection.name}">Delete</button>
                        </div>
                    </div>
                `).join('')}
            </div>
